...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">TV Series</div>
...
<a id="btnEmpty" href="tv-series.php?action=empty">Empty Cart</a>
<?php
...
<?php
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="tv-series.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
...
<!-- //Session Cart -->
  ...
  <div id="product-grid">
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE category=2");
	if (!empty($product_array)) {
		foreach($product_array as $key=>$value){
	?>
		<div class="product-item">
			<form method="post" action="tv-series.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
