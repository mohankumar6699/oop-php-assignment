...
<!DOCTYPE html>
<html>
<title>Best Movies & TV Series</title>
<meta charset="UTF-8">
...
body{
  background-image: url("w3images/Feature image.png");
...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <a href="login.html"  class="w3-bar-item w3-button">Login</a>
	<a href="dashboard oop/dashboardoop.php"  class="w3-bar-item w3-button">Dashboard</a>
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">Best Movies & TV Series</div>
