...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    ...
    if ($conn->query($sql) === TRUE) {
       ...
       echo '<p style="text-align: center; margin-top: 20px;">One Product Deleted Successfully</p>';
       echo '<p style="text-align: center; margin-top: 20px;"><a href="all-products.php">Back</a></p>';
